			 ...
			 int namelen)
{
	...
	if (kb->cmd == DLM_USER_CREATE_LOCKSPACE ||
		...
		kb->i.lock.castparam = (void __user *)(uintptr_t)kb32->i.lock.castparam;
		kb->i.lock.castaddr = (void __user *)(uintptr_t)kb32->i.lock.castaddr;
		kb->i.lock.bastparam = (void __user *)(uintptr_t)kb32->i.lock.bastparam;
		kb->i.lock.bastaddr = (void __user *)(uintptr_t)kb32->i.lock.bastaddr;
		kb->i.lock.lksb = (void __user *)(uintptr_t)kb32->i.lock.lksb;
