...
/* FIXCHERI: Implement properly. */
#define unsafe_get_user_ptr(x,p,e) do { if (__get_user_ptr(x,p)) goto e; } while (0)
#define unsafe_put_user_ptr(x,p,e) do { if (__put_user_ptr(x,p)) goto e; } while (0)
