...
static void __init __PI create_pte_mapping(pte_t *ptep,
...
static void __init __PI create_pmd_mapping(pmd_t *pmdp,
				      unsigned long va, phys_addr_t pa,
				      phys_addr_t sz, pgprot_t prot)
{
	pte_t *ptep;
...
static void __init __PI create_pud_mapping(pud_t *pudp,
				      unsigned long va, phys_addr_t pa,
				      phys_addr_t sz, pgprot_t prot)
{
	pmd_t *nextp;
...
void __init __PI create_pgd_mapping(pgd_t *pgdp,
				      unsigned long va, phys_addr_t pa,
				      phys_addr_t sz, pgprot_t prot)
{
	pgd_next_t *nextp;
...
#else
static void __init __PI create_kernel_page_table(pgd_t *pgdir, bool early)
{
	unsigned long va, end_va;
