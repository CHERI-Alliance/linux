...
#define RISCV_ISA_EXT_ZCHERIPURECAP	100
#define RISCV_ISA_EXT_ZCHERIHYBRID	101
#define RISCV_ISA_EXT_ZCHERIPTE		102
#define RISCV_ISA_EXT_ZISH4ADD		103
#define RISCV_ISA_EXT_ZABHLRSC		104
#define RISCV_ISA_EXT_ZCHERILEVELS		105
