...
#define insb(addr, buffer, count) __insb(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
#define insw(addr, buffer, count) __insw(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
#define insl(addr, buffer, count) __insl(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
...
#define outsb(addr, buffer, count) __outsb(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
#define outsw(addr, buffer, count) __outsw(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
#define outsl(addr, buffer, count) __outsl(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
...
#define insq(addr, buffer, count) __insq(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)

__io_writes_outs(writes, u64, q, __io_bw(), __io_aw())
#define writesq(addr, buffer, count) __writesq(addr, buffer, count)

__io_writes_outs(outs, u64, q, __io_pbr(), __io_paw())
#define outsq(addr, buffer, count) __outsq(PCI_IOBASE + (__ptraddr_t)(addr), buffer, count)
#endif
