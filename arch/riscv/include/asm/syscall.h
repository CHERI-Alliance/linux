					 ...
					 const uintptr_t *args)
{
	 ...
	 */
	regs->orig_a0 = (register_t)cheri_address_set(regs->orig_a0, __c_ua(args[0]));
	regs->a1 = (register_t)cheri_address_set(regs->a1, __c_ua(args[1]));
	regs->a2 = (register_t)cheri_address_set(regs->a2, __c_ua(args[2]));
	regs->a3 = (register_t)cheri_address_set(regs->a3, __c_ua(args[3]));
	regs->a4 = (register_t)cheri_address_set(regs->a4, __c_ua(args[4]));
	regs->a5 = (register_t)cheri_address_set(regs->a5, __c_ua(args[5]));
}
