				    ...
				    void *priv)
{
	...
	if (func->function.ss_descriptors) {
		ep_desc_id = 2;
		func->function.ss_descriptors[__c_ua((intptr_t)valuep)] = desc;
	} else if (func->function.hs_descriptors) {
		ep_desc_id = 1;
		func->function.hs_descriptors[__c_ua((intptr_t)valuep)] = desc;
	} else {
		ep_desc_id = 0;
		func->function.fs_descriptors[__c_ua((intptr_t)valuep)]    = desc;
	}
