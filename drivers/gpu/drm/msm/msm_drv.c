		...
		struct drm_file *file)
{
	...
	switch (args->info) {
	case MSM_INFO_GET_OFFSET:
		args->value = __c_fakeu(msm_gem_mmap_offset(obj));
		break;
	case MSM_INFO_GET_IOVA:
...
static const struct drm_ioctl_desc msm_ioctls[] = {
	DRM_IOCTL_DEF_DRV_C64(MSM_GET_PARAM,    msm_ioctl_get_param,    DRM_RENDER_ALLOW, drm_msm_param),
	DRM_IOCTL_DEF_DRV_C64(MSM_SET_PARAM,    msm_ioctl_set_param,    DRM_RENDER_ALLOW, drm_msm_param),
	DRM_IOCTL_DEF_DRV    (MSM_GEM_NEW,      msm_ioctl_gem_new,      DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV_C64(MSM_GEM_INFO,     msm_ioctl_gem_info,     DRM_RENDER_ALLOW, drm_msm_gem_info),
	DRM_IOCTL_DEF_DRV    (MSM_GEM_CPU_PREP, msm_ioctl_gem_cpu_prep, DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV    (MSM_GEM_CPU_FINI, msm_ioctl_gem_cpu_fini, DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV_C64(MSM_GEM_SUBMIT,   msm_ioctl_gem_submit,   DRM_RENDER_ALLOW, drm_msm_gem_submit),
	DRM_IOCTL_DEF_DRV    (MSM_WAIT_FENCE,   msm_ioctl_wait_fence,   DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV    (MSM_GEM_MADVISE,  msm_ioctl_gem_madvise,  DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV    (MSM_SUBMITQUEUE_NEW,   msm_ioctl_submitqueue_new,   DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV    (MSM_SUBMITQUEUE_CLOSE, msm_ioctl_submitqueue_close, DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV_C64(MSM_SUBMITQUEUE_QUERY, msm_ioctl_submitqueue_query, DRM_RENDER_ALLOW, drm_msm_submitqueue_query),
	DRM_IOCTL_DEF_DRV_C64(MSM_VM_BIND,      msm_ioctl_vm_bind,      DRM_RENDER_ALLOW, drm_msm_vm_bind),
};
