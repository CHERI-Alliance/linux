			  ...
			  unsigned int nblocks, u32 hibit)
{
	...
	do {
		...
		/* h *= r */
		d0 = (u128 __force)h0 * r0;
		d = (u128 __force)h1 * s2;
		d0 += d;
		d = (u128 __force)h2 * s1;
		d0 += d;
		d1 = (u128 __force)h0 * r1;
		d = (u128 __force)h1 * r0;
		d1 += d;
		d = (u128 __force)h2 * s2;
		d1 += d;
		d2 = (u128 __force)h0 * r2;
		d = (u128 __force)h1 * r1;
		d2 += d;
		d = (u128 __force)h2 * r0;
		d2 += d;

		/* (partial) h %= p */
		c = (u64 __force)(d0 >> 44);
		h0 = (u64 __force)d0 & 0xfffffffffffULL;
		d1 += c;
		c = (u64 __force)(d1 >> 44);
		h1 = (u64 __force)d1 & 0xfffffffffffULL;
		d2 += c;
		c = (u64 __force)(d2 >> 42);
		h2 = (u64 __force)d2 & 0x3ffffffffffULL;
		h0 += c * 5;
		c = h0 >> 44;
