 ...
 */
#if BITS_PER_LONG == 64 && !defined(CONFIG_CHERI_KERNEL)
...
enum {
	...
	DECLARE_VMA_BIT_ALIAS(READ_CAPS, HIGH_ARCH_2),
	DECLARE_VMA_BIT_ALIAS(WRITE_CAPS, HIGH_ARCH_3),
#elif defined(CONFIG_RISCV_CHERI)
	DECLARE_VMA_BIT_ALIAS(READ_CAPS, HIGH_ARCH_0),
	DECLARE_VMA_BIT_ALIAS(WRITE_CAPS, HIGH_ARCH_1),
#endif
};
...
#define VM_READ_CAPS	INIT_VM_FLAG(READ_CAPS)
#define VM_WRITE_CAPS	INIT_VM_FLAG(WRITE_CAPS)
#else
...
static inline struct page *pmd_pgtable_page(pmd_t *pmd)
{
	...
	return virt_to_page((void *)(uintptr_t)((uintptr_t) pmd & mask));
}
