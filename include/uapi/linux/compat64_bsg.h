...
struct __c64_bsg_uring_cmd {
	__c64_ptr64 request;	/* [i], [*i] command descriptor address */
	...
	__c64_ptr64 response;		/* [i], [*o] response data address */
	__c64_ptr64 dout_xferp;	/* [i], [*i] */
	__u32 dout_xfer_len;	/* [i] bytes to be transferred to device */
	__u32 dout_iovec_count;	/* [i] 0 -> "flat" dout transfer else
...
static __always_inline __maybe_unused void
__from_c64_bsg_uring_cmd(struct bsg_uring_cmd *p)
{
	union {
		struct bsg_uring_cmd native;
		const struct __c64_bsg_uring_cmd compat;
	} *u = (void *)p;
...
static __always_inline __maybe_unused void
__to_c64_bsg_uring_cmd(struct bsg_uring_cmd *p)
{
	union {
		struct __c64_bsg_uring_cmd compat;
		const struct bsg_uring_cmd native;
	} *u = (void *)p;
...
static __always_inline __maybe_unused void
__from_c64_bsg_uring_cmd_2(struct bsg_uring_cmd *native, const struct __c64_bsg_uring_cmd *compat)
{
...
static __always_inline __maybe_unused void
__to_c64_bsg_uring_cmd_2(struct __c64_bsg_uring_cmd *compat, const struct bsg_uring_cmd *native)
{
