...
struct drm_exynos_g2d_set_cmdlist {
	__kernel_uintptr_t			cmd;
	__kernel_uintptr_t			cmd_buf;
	__u32					cmd_nr;
	__u32					cmd_buf_nr;
...
struct drm_exynos_ioctl_ipp_get_caps {
	...
	__u32 reserved;
	__u32 formats_count;
	__kernel_uintptr_t formats_ptr;
};
